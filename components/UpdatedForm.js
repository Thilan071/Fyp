...
//   const [nic, setNic] = useState('');
//   const [mobileNumber, setMobileNumber] = useState('');
//   // Additional states for validations
...
//     if (!caseLocation.trim()) {
//       tempErrors.caseLocation = 'Case location is required';
//       isValid = false;
//     }
...
//       tempErrors.mobileNumber = 'Mobile number must contain 10 digits';
//       isValid = false;
//     }
...
//   // Rest of your component including useEffects, other handler functions...

//   return (
//     <ScrollView style={styles.container}>
//       {/* Example input field with validation for caseLocation */}
//       <TextInput
//         label="Case Location"
//         value={caseLocation}
//         onChangeText={text => setCaseLocation(text)}
//         style={styles.input}
//       />
//       {errors.caseLocation && <Text style={styles.errorText}>{errors.caseLocation}</Text>}

//       {/* NIC input field with validation */}
//       <TextInput
//         label="NIC"
//         value={nic}
