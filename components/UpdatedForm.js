...
//     await addDataToFirestore(); // First add data to "DRIVER DETAILS"
//     await transferDataToCasesCollection(); // Then transfer required data to "cases"
//     navigation.navigate('CameraScreen'); // Navigate to the next screen
//   };

//   const addDataToFirestore = async () => {
//     try {
//       await collection(doc(db, "DRIVER DETAILS"), {
//         caseDate,
//         caseTime,
//         caseLocation,
//         caseDirection,
...
//         penaltyCost,
//       });
//       console.log("Data added to 'DRIVER DETAILS' successfully");
//     } catch (error) {
//       console.error("Error adding data to 'DRIVER DETAILS':", error);
//     }
//   };
